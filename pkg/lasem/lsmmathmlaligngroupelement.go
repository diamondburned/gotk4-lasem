...
func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeMathMLAlignGroupElement, F: marshalMathMLAlignGroupElement},
	})
}
...
var (
	_ MathMLElementer = (*MathMLAlignGroupElement)(nil)
)

func classInitMathMLAlignGroupElementer(gclassPtr, data C.gpointer) {
