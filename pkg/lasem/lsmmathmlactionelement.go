...
func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeMathMLActionElement, F: marshalMathMLActionElement},
	})
}
...
var (
	_ MathMLPresentationContainerer = (*MathMLActionElement)(nil)
)

func classInitMathMLActionElementer(gclassPtr, data C.gpointer) {
...
func wrapMathMLActionElement(obj *externglib.Object) *MathMLActionElement {
