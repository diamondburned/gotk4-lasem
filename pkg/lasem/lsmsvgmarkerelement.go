...
var GTypeSVGMarkerElement = externglib.Type(C.lsm_svg_marker_element_get_type())

func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeSVGMarkerElement, F: marshalSVGMarkerElement},
	})
}
...
var (
	_ SVGElementer = (*SVGMarkerElement)(nil)
)

func classInitSVGMarkerElementer(gclassPtr, data C.gpointer) {
...
func wrapSVGMarkerElement(obj *externglib.Object) *SVGMarkerElement {
...
func marshalSVGMarkerElement(p uintptr) (interface{}, error) {
	return wrapSVGMarkerElement(externglib.ValueFromNative(unsafe.Pointer(p)).Object()), nil
}
...
func NewSVGMarkerElement() *SVGMarkerElement {
	...
	_cret = C.lsm_svg_marker_element_new()

	var _svgMarkerElement *SVGMarkerElement // out

	_svgMarkerElement = wrapSVGMarkerElement(externglib.AssumeOwnership(unsafe.Pointer(_cret)))

	return _svgMarkerElement
}
...
func (marker *SVGMarkerElement) Render(view *SVGView, strokeWidth, vertexAngle float64) {
	var _arg0 *C.LsmSvgMarkerElement // out
	var _arg1 *C.LsmSvgView          // out
	var _arg2 C.double               // out
	var _arg3 C.double               // out

	_arg0 = (*C.LsmSvgMarkerElement)(unsafe.Pointer(externglib.InternObject(marker).Native()))
	_arg1 = (*C.LsmSvgView)(unsafe.Pointer(externglib.InternObject(view).Native()))
	_arg2 = C.double(strokeWidth)
	_arg3 = C.double(vertexAngle)

	C.lsm_svg_marker_element_render(_arg0, _arg1, _arg2, _arg3)
	runtime.KeepAlive(marker)
	runtime.KeepAlive(view)
	runtime.KeepAlive(strokeWidth)
	runtime.KeepAlive(vertexAngle)
}
