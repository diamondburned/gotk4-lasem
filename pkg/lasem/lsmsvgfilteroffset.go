...
var GTypeSVGFilterOffset = externglib.Type(C.lsm_svg_filter_offset_get_type())

func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeSVGFilterOffset, F: marshalSVGFilterOffset},
	})
}
...
var (
	_ SVGFilterPrimitiver = (*SVGFilterOffset)(nil)
)

func classInitSVGFilterOffsetter(gclassPtr, data C.gpointer) {
...
func wrapSVGFilterOffset(obj *externglib.Object) *SVGFilterOffset {
