...
func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeSVGFilterSpecularLighting, F: marshalSVGFilterSpecularLighting},
	})
}
...
var (
	_ SVGFilterPrimitiver = (*SVGFilterSpecularLighting)(nil)
)

func classInitSVGFilterSpecularLightinger(gclassPtr, data C.gpointer) {
...
func wrapSVGFilterSpecularLighting(obj *externglib.Object) *SVGFilterSpecularLighting {
