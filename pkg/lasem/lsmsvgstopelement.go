...
var GTypeSVGStopElement = externglib.Type(C.lsm_svg_stop_element_get_type())

func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeSVGStopElement, F: marshalSVGStopElement},
	})
}
...
var (
	_ SVGElementer = (*SVGStopElement)(nil)
)

func classInitSVGStopElementer(gclassPtr, data C.gpointer) {
