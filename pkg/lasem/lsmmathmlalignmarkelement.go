...
func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeMathMLAlignMarkElement, F: marshalMathMLAlignMarkElement},
	})
}
...
var (
	_ MathMLElementer = (*MathMLAlignMarkElement)(nil)
)

func classInitMathMLAlignMarkElementer(gclassPtr, data C.gpointer) {
