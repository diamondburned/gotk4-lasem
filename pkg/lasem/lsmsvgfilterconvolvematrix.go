...
func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeSVGFilterConvolveMatrix, F: marshalSVGFilterConvolveMatrix},
	})
}
...
var (
	_ SVGFilterPrimitiver = (*SVGFilterConvolveMatrix)(nil)
)

func classInitSVGFilterConvolveMatrixer(gclassPtr, data C.gpointer) {
...
func wrapSVGFilterConvolveMatrix(obj *externglib.Object) *SVGFilterConvolveMatrix {
