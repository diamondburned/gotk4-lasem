...
func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeMathMLFractionElement, F: marshalMathMLFractionElement},
	})
}
...
var (
	_ MathMLElementer = (*MathMLFractionElement)(nil)
)

func classInitMathMLFractionElementer(gclassPtr, data C.gpointer) {
