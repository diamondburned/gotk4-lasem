...
var GTypeSVGMaskElement = externglib.Type(C.lsm_svg_mask_element_get_type())

func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeSVGMaskElement, F: marshalSVGMaskElement},
	})
}
...
var (
	_ SVGElementer = (*SVGMaskElement)(nil)
)

func classInitSVGMaskElementer(gclassPtr, data C.gpointer) {
