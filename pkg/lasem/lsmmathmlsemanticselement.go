...
func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeMathMLSemanticsElement, F: marshalMathMLSemanticsElement},
	})
}
...
var (
	_ MathMLElementer = (*MathMLSemanticsElement)(nil)
)

func classInitMathMLSemanticsElementer(gclassPtr, data C.gpointer) {
