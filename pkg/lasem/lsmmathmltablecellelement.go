...
func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeMathMLTableCellElement, F: marshalMathMLTableCellElement},
	})
}
...
var (
	_ MathMLElementer = (*MathMLTableCellElement)(nil)
)

func classInitMathMLTableCellElementer(gclassPtr, data C.gpointer) {
...
func (self *MathMLTableCellElement) Spans(rowSpan, columnSpan *uint) {
	var _arg0 *C.LsmMathmlTableCellElement // out
	var _arg1 *C.uint                      // out
	var _arg2 *C.uint                      // out

	_arg0 = (*C.LsmMathmlTableCellElement)(unsafe.Pointer(externglib.InternObject(self).Native()))
	_arg1 = (*C.uint)(unsafe.Pointer(rowSpan))
	_arg2 = (*C.uint)(unsafe.Pointer(columnSpan))

	C.lsm_mathml_table_cell_element_get_spans(_arg0, _arg1, _arg2)
