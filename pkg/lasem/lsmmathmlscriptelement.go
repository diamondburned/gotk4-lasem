...
func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeMathMLScriptElement, F: marshalMathMLScriptElement},
	})
}
...
var (
	_ MathMLElementer = (*MathMLScriptElement)(nil)
)

func classInitMathMLScriptElementer(gclassPtr, data C.gpointer) {
...
func marshalMathMLScriptElement(p uintptr) (interface{}, error) {
	return wrapMathMLScriptElement(externglib.ValueFromNative(unsafe.Pointer(p)).Object()), nil
}
