...
var GTypeSVGTransformable = externglib.Type(C.lsm_svg_transformable_get_type())

func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeSVGTransformable, F: marshalSVGTransformable},
	})
}
...
var (
	_ SVGElementer = (*SVGTransformable)(nil)
)
...
type SVGTransformabler interface {
	externglib.Objector
	baseSVGTransformable() *SVGTransformable
}

var _ SVGTransformabler = (*SVGTransformable)(nil)

func classInitSVGTransformabler(gclassPtr, data C.gpointer) {
...
func marshalSVGTransformable(p uintptr) (interface{}, error) {
	return wrapSVGTransformable(externglib.ValueFromNative(unsafe.Pointer(p)).Object()), nil
}

func (v *SVGTransformable) baseSVGTransformable() *SVGTransformable {
	return v
}

// BaseSVGTransformable returns the underlying base object.
func BaseSVGTransformable(obj SVGTransformabler) *SVGTransformable {
	return obj.baseSVGTransformable()
}
