...
var GTypeMathMLItexElement = externglib.Type(C.lsm_mathml_itex_element_get_type())

func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeMathMLItexElement, F: marshalMathMLItexElement},
	})
}
...
var (
	_ MathMLElementer = (*MathMLItexElement)(nil)
)

func classInitMathMLItexElementer(gclassPtr, data C.gpointer) {
