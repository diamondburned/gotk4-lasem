...
func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeMathMLUnderOverElement, F: marshalMathMLUnderOverElement},
	})
}
...
var (
	_ MathMLElementer = (*MathMLUnderOverElement)(nil)
)

func classInitMathMLUnderOverElementer(gclassPtr, data C.gpointer) {
