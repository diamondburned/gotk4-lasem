...
var GTypeSVGTspanElement = externglib.Type(C.lsm_svg_tspan_element_get_type())

func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeSVGTspanElement, F: marshalSVGTspanElement},
	})
}
...
var (
	_ SVGElementer = (*SVGTspanElement)(nil)
)

func classInitSVGTspanElementer(gclassPtr, data C.gpointer) {
