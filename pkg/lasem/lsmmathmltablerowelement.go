...
func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeMathMLTableRowElement, F: marshalMathMLTableRowElement},
	})
}
...
var (
	_ MathMLElementer = (*MathMLTableRowElement)(nil)
)

func classInitMathMLTableRowElementer(gclassPtr, data C.gpointer) {
