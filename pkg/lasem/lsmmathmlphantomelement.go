...
func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeMathMLPhantomElement, F: marshalMathMLPhantomElement},
	})
}
...
var (
	_ MathMLElementer = (*MathMLPhantomElement)(nil)
)

func classInitMathMLPhantomElementer(gclassPtr, data C.gpointer) {
