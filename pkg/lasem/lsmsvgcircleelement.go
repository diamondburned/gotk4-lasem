...
var GTypeSVGCircleElement = externglib.Type(C.lsm_svg_circle_element_get_type())

func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeSVGCircleElement, F: marshalSVGCircleElement},
	})
}
...
var (
	_ SVGTransformabler = (*SVGCircleElement)(nil)
)

func classInitSVGCircleElementer(gclassPtr, data C.gpointer) {
...
func wrapSVGCircleElement(obj *externglib.Object) *SVGCircleElement {
