...
var GTypeSVGFilterComposite = externglib.Type(C.lsm_svg_filter_composite_get_type())

func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeSVGFilterComposite, F: marshalSVGFilterComposite},
	})
}
...
var (
	_ SVGFilterPrimitiver = (*SVGFilterComposite)(nil)
)

func classInitSVGFilterCompositer(gclassPtr, data C.gpointer) {
...
func wrapSVGFilterComposite(obj *externglib.Object) *SVGFilterComposite {
