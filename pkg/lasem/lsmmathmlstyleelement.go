...
var GTypeMathMLStyleElement = externglib.Type(C.lsm_mathml_style_element_get_type())

func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeMathMLStyleElement, F: marshalMathMLStyleElement},
	})
}
...
var (
	_ MathMLPresentationContainerer = (*MathMLStyleElement)(nil)
)

func classInitMathMLStyleElementer(gclassPtr, data C.gpointer) {
...
func wrapMathMLStyleElement(obj *externglib.Object) *MathMLStyleElement {
