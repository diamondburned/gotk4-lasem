...
var GTypeSVGSymbolElement = externglib.Type(C.lsm_svg_symbol_element_get_type())

func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeSVGSymbolElement, F: marshalSVGSymbolElement},
	})
}
...
var (
	_ SVGElementer = (*SVGSymbolElement)(nil)
)

func classInitSVGSymbolElementer(gclassPtr, data C.gpointer) {
