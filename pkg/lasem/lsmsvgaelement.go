...
var GTypeSVGAElement = externglib.Type(C.lsm_svg_a_element_get_type())

func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeSVGAElement, F: marshalSVGAElement},
	})
}
...
var (
	_ SVGTransformabler = (*SVGAElement)(nil)
)

func classInitSVGAElementer(gclassPtr, data C.gpointer) {
...
func wrapSVGAElement(obj *externglib.Object) *SVGAElement {
	return &SVGAElement{
