...
var GTypeSVGFilterFlood = externglib.Type(C.lsm_svg_filter_flood_get_type())

func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeSVGFilterFlood, F: marshalSVGFilterFlood},
	})
}
...
var (
	_ SVGFilterPrimitiver = (*SVGFilterFlood)(nil)
)

func classInitSVGFilterFlooder(gclassPtr, data C.gpointer) {
...
func wrapSVGFilterFlood(obj *externglib.Object) *SVGFilterFlood {
