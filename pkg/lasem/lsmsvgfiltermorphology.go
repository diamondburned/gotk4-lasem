...
func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeSVGFilterMorphology, F: marshalSVGFilterMorphology},
	})
}
...
var (
	_ SVGFilterPrimitiver = (*SVGFilterMorphology)(nil)
)

func classInitSVGFilterMorphologier(gclassPtr, data C.gpointer) {
...
func wrapSVGFilterMorphology(obj *externglib.Object) *SVGFilterMorphology {
