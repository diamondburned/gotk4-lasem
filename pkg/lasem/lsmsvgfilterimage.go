...
var GTypeSVGFilterImage = externglib.Type(C.lsm_svg_filter_image_get_type())

func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeSVGFilterImage, F: marshalSVGFilterImage},
	})
}
...
var (
	_ SVGFilterPrimitiver = (*SVGFilterImage)(nil)
)

func classInitSVGFilterImager(gclassPtr, data C.gpointer) {
...
func wrapSVGFilterImage(obj *externglib.Object) *SVGFilterImage {
