...
var GTypeSVGFilterColorMatrix = externglib.Type(C.lsm_svg_filter_color_matrix_get_type())

func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeSVGFilterColorMatrix, F: marshalSVGFilterColorMatrix},
	})
}
...
var (
	_ SVGFilterPrimitiver = (*SVGFilterColorMatrix)(nil)
)

func classInitSVGFilterColorMatrixer(gclassPtr, data C.gpointer) {
...
func wrapSVGFilterColorMatrix(obj *externglib.Object) *SVGFilterColorMatrix {
