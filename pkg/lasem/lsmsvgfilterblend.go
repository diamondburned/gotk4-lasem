...
var GTypeSVGFilterBlend = externglib.Type(C.lsm_svg_filter_blend_get_type())

func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeSVGFilterBlend, F: marshalSVGFilterBlend},
	})
}
...
var (
	_ SVGFilterPrimitiver = (*SVGFilterBlend)(nil)
)

func classInitSVGFilterBlender(gclassPtr, data C.gpointer) {
...
func wrapSVGFilterBlend(obj *externglib.Object) *SVGFilterBlend {
