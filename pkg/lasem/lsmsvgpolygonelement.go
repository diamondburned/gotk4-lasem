...
var GTypeSVGPolygonElement = externglib.Type(C.lsm_svg_polygon_element_get_type())

func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeSVGPolygonElement, F: marshalSVGPolygonElement},
	})
}
...
var (
	_ SVGTransformabler = (*SVGPolygonElement)(nil)
)

func classInitSVGPolygonElementer(gclassPtr, data C.gpointer) {
...
func wrapSVGPolygonElement(obj *externglib.Object) *SVGPolygonElement {
