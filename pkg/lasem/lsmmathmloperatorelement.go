...
func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeMathMLOperatorElement, F: marshalMathMLOperatorElement},
	})
}
...
var (
	_ MathMLElementer = (*MathMLOperatorElement)(nil)
)

func classInitMathMLOperatorElementer(gclassPtr, data C.gpointer) {
...
func wrapMathMLOperatorElement(obj *externglib.Object) *MathMLOperatorElement {
...
func (operatorElement *MathMLOperatorElement) Slant(view *MathMLView) float64 {
	var _arg0 *C.LsmMathmlOperatorElement // out
	var _arg1 *C.LsmMathmlView            // out
	var _cret C.double                    // in

	_arg0 = (*C.LsmMathmlOperatorElement)(unsafe.Pointer(externglib.InternObject(operatorElement).Native()))
	_arg1 = (*C.LsmMathmlView)(unsafe.Pointer(externglib.InternObject(view).Native()))

	_cret = C.lsm_mathml_operator_element_get_slant(_arg0, _arg1)
	runtime.KeepAlive(operatorElement)
