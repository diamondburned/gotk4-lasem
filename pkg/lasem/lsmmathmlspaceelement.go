...
var GTypeMathMLSpaceElement = externglib.Type(C.lsm_mathml_space_element_get_type())

func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeMathMLSpaceElement, F: marshalMathMLSpaceElement},
	})
}
...
var (
	_ MathMLElementer = (*MathMLSpaceElement)(nil)
)

func classInitMathMLSpaceElementer(gclassPtr, data C.gpointer) {
