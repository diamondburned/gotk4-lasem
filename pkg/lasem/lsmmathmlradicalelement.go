...
func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeMathMLRadicalElement, F: marshalMathMLRadicalElement},
	})
}
...
var (
	_ MathMLElementer = (*MathMLRadicalElement)(nil)
)

func classInitMathMLRadicalElementer(gclassPtr, data C.gpointer) {
...
func marshalMathMLRadicalElement(p uintptr) (interface{}, error) {
	return wrapMathMLRadicalElement(externglib.ValueFromNative(unsafe.Pointer(p)).Object()), nil
}
