...
func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeMathMLPresentationContainer, F: marshalMathMLPresentationContainer},
	})
}
...
var (
	_ MathMLElementer = (*MathMLPresentationContainer)(nil)
)
...
type MathMLPresentationContainerer interface {
	externglib.Objector
	baseMathMLPresentationContainer() *MathMLPresentationContainer
}

var _ MathMLPresentationContainerer = (*MathMLPresentationContainer)(nil)

func classInitMathMLPresentationContainerer(gclassPtr, data C.gpointer) {
...
func marshalMathMLPresentationContainer(p uintptr) (interface{}, error) {
	return wrapMathMLPresentationContainer(externglib.ValueFromNative(unsafe.Pointer(p)).Object()), nil
}

func (v *MathMLPresentationContainer) baseMathMLPresentationContainer() *MathMLPresentationContainer {
	return v
}
...
func BaseMathMLPresentationContainer(obj MathMLPresentationContainerer) *MathMLPresentationContainer {
	return obj.baseMathMLPresentationContainer()
}
