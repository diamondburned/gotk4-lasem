...
func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeSVGFilterTurbulence, F: marshalSVGFilterTurbulence},
	})
}
...
var (
	_ SVGFilterPrimitiver = (*SVGFilterTurbulence)(nil)
)

func classInitSVGFilterTurbulencer(gclassPtr, data C.gpointer) {
...
func wrapSVGFilterTurbulence(obj *externglib.Object) *SVGFilterTurbulence {
