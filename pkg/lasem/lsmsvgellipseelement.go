...
var GTypeSVGEllipseElement = externglib.Type(C.lsm_svg_ellipse_element_get_type())

func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		{T: GTypeSVGEllipseElement, F: marshalSVGEllipseElement},
	})
}
...
var (
	_ SVGTransformabler = (*SVGEllipseElement)(nil)
)

func classInitSVGEllipseElementer(gclassPtr, data C.gpointer) {
...
func wrapSVGEllipseElement(obj *externglib.Object) *SVGEllipseElement {
